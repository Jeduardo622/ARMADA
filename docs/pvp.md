...
- [ ] When ships sail beyond the opening frame the camera follows —
      zooming out and re-centering so every living ship (and its bars)
      stays in view. As the fight concentrates the camera eases in,
      down to its zoom floor; wrecks may drift out of frame.
