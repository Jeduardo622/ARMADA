# Mission 04: Boarding Party
- Narrative beat: Introduce boarding risk/reward.
- Objectives: Win; bonus—successful boarding; bonus—no ship sunk.
- Enemy setup: 2x light frigates (AI: line-advance); will expose flanks.
