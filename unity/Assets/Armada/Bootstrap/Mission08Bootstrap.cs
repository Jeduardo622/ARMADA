...
namespace Armada.Client.Bootstrap
{
    ...
    public sealed class Mission08Bootstrap : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            if (FindFirstObjectByType<ArmadaBootstrap>() != null || FindFirstObjectByType<Mission07Bootstrap>() != null || FindFirstObjectByType<Mission09Bootstrap>() != null || FindFirstObjectByType<Mission10Bootstrap>() != null || FindFirstObjectByType<PvpHotseatBootstrap>() != null || FindFirstObjectByType<PvpNetplayBootstrap>() != null)
            {
